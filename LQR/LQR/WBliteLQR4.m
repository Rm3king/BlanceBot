...
Q_leg = [4000 0 0 0 0 0;0 1000 0 0 0 0;0 0 300 0 0 0; 0 0 0 200 0 0;0 0 0 0 2000 0; 0 0 0 0 0 20];
R_leg = [5 0; 0 3]; %权重矩阵 R 的设计
...
K = LQRFun(BasicData,ValData,Q_leg,R_leg);
fprintf('\t/* leg_K -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
%%腿长160mm
