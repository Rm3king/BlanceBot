...
%腿长150mm
%可变量，腿长决定
ValData = [0.116,0.034,0.944807129,0.009288675];
...
Q = [300 0 0 0 0 0; 0 300 0 0 0 0; 0 0 300 0 0 0; 0 0 0 300 0 0; 0 0 0 0 4800 0; 0 0 0 0 0 20]; 
...
%%腿长160mm
ValData = [0.118,0.042,0.944807129,0.0107100532845169];
...
ValData = [0.125,0.057,0.944807129,0.0138040778499579];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.127,0.061,0.944807129,0.0148374694685144];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.131,0.068,0.944807129,0.0165142284610285];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.135,0.074,0.944807129,0.0183416715341035];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.14,0.081,0.944807129,0.0203156781696676];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.144,0.088,0.944807129,0.022429290030841];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.148,0.092,0.944807129,0.0239112529871359];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.152,0.098,0.944807129,0.0262347945998448];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.158,0.105,0.944807129,0.028666678004804];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.161,0.109,0.944807129,0.0303403913297717];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.166,0.115,0.944807129,0.0329168106403138];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.171,0.121,0.944807129,0.0355555939449514];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.175,0.125,0.944807129,0.0373396579133954];
%  Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
...
ValData = [0.18,0.13,0.944807129,0.0400377397747617];
...
%%腿长160mm
ValData = [0.185,0.135,0.944807129,0.0427432475252028];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.19,0.14,0.944807129,0.0454344805443938];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.194,0.145,0.944807129,0.0480896074940502];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.201,0.151,0.944807129,0.0515362025207683];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.205,0.155,0.944807129,0.0540235587342414];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.21,0.16,0.944807129,0.0571713714323725];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.215,0.164,0.944807129,0.0600851677083373];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.221,0.169,0.944807129,0.063336037776738];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
ValData = [0.227,0.173,0.944807129,0.066572803627223];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
