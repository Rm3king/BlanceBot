...
__PACKED_STRUCT robot_referee_status_t
{
	...
	ext_air_support_data_t ext_air_support_data;
	#endif
	...
	ext_shoot_data_t ext_shoot_data;
		...
		ext_projectile_allowance_t ext_projectile_allowance;
		#elif (RF_GAME_MODE==0x00)//RMUL
		typedef __PACKED_STRUCT
		{
	...
	ext_client_map_command_t ext_client_map_command;
		...
		ext_custom_client_data_t ext_custom_client_data;
		#endif
